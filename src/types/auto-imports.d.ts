...
export {}
declare global {
  const Decimal: typeof import('decimal.js')['default']
  ...
  const delay: typeof import('delay')['default']
  const effectScope: typeof import('vue')['effectScope']
...
declare global {
  ...
  import('dayjs')
  // @ts-ignore
  export type { FormRule } from '@form-create/ant-design-vue'
  import('@form-create/ant-design-vue')
  // @ts-ignore
  export type { TableColumnsType } from 'ant-design-vue'
  import('ant-design-vue')
  // @ts-ignore
  export type { UseAxiosOptions } from '@vueuse/integrations/useAxios'
